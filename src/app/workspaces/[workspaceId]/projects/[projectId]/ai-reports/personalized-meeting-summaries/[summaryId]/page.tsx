...
import { getPersonalizedMeetingSummaryDetail } from "@/features/ai-reports/api/ai-personalized-meeting-summary.api";
...
export default function PersonalizedMeetingSummaryDetailPage() {
      ...
      <div className="mx-auto max-w-6xl space-y-6 pb-12">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.18em] text-blue-600">
                AI personalized summary detail
              </p>
              <h1 className="mt-1 text-2xl font-black text-zinc-950">
                Participant summary version
              </h1>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {summary ? (
                <Link
                  ...
                  href={`/workspaces/${params.workspaceId}/projects/${params.projectId}/meetings/${summary.meetingId}/personalized-summary`}
                >
                  Meeting view
                </Link>
              ) : null}
        ...
        {isLoading ? (
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 text-sm font-semibold text-zinc-700 shadow-sm">
            Personalized meeting summary not found.
          </div>
        )}
      </div>
    </AppShell>
