...
export function DashboardRecentActivity({
  ...
  if (isLoading) {
    return (
      <div className="flex h-48 items-center justify-center rounded-3xl border border-slate-200/80 bg-white p-6 text-xs font-semibold text-slate-500 shadow-xs">
  ...
  return (
    <div className="space-y-4 rounded-3xl border border-slate-200/80 bg-white p-6 shadow-xs">
      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
        <div>
          <h2 className="text-base font-extrabold text-slate-900">Hoạt động & Công việc gần đây</h2>
            ...
            return (
              <li key={task.id}>
                <Link
                  ...
                  className="group flex items-start justify-between gap-3 rounded-2xl border border-slate-100 bg-slate-50/60 p-3.5 transition-all hover:border-blue-200 hover:bg-blue-50/40 hover:shadow-2xs"
                >
                  <div className="flex items-start gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="truncate text-xs font-extrabold text-slate-900 transition-colors group-hover:text-blue-600">
